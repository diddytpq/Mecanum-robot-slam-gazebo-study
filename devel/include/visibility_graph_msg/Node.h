...
struct Node_
{
  ...
  _position_type position;
   ...
   typedef std::vector< ::geometry_msgs::Point_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::geometry_msgs::Point_<ContainerAllocator> >::other >  _surface_dirs_type;
  ...
  _is_boundary_type is_boundary;
   ...
   typedef std::vector<uint32_t, typename ContainerAllocator::template rebind<uint32_t>::other >  _connect_nodes_type;
  _connect_nodes_type connect_nodes;

   typedef std::vector<uint32_t, typename ContainerAllocator::template rebind<uint32_t>::other >  _poly_connects_type;
  _poly_connects_type poly_connects;

   typedef std::vector<uint32_t, typename ContainerAllocator::template rebind<uint32_t>::other >  _contour_connects_type;
  _contour_connects_type contour_connects;

   typedef std::vector<uint32_t, typename ContainerAllocator::template rebind<uint32_t>::other >  _trajectory_connects_type;
